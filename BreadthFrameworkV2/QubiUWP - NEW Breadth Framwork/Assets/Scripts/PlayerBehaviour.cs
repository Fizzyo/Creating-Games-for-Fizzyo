...
public class PlayerBehaviour : MonoBehaviour
{
    ...
    void Update()
    {
        if (ScoreManager.Instance.currentStage == ScoreManager.GameStage.LevelPlaying && (Input.GetKeyDown(KeyCode.Space) || Input.GetKeyDown("joystick button 0")))
        {
            Jump();
        }
    }
    ...
    void Jump()
    {
        if (availableJumpCount > 0)
        {
            ...
            FizzyoOverlay.UnlockAchievement("Learn To Jump!", 1);
        }
    }
