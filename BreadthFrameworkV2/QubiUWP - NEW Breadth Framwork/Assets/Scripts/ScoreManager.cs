...
public class ScoreManager : MonoBehaviour
{
    ...
    private FizzyoOverlay FizzyoOverlay;
    ...
    private void Start()
    {
        ...
        FizzyoOverlay = GameObject.Find("FizzyoOverlay").GetComponent<FizzyoOverlay>();
    ...
    public void GoodBreathAnimation()
    {
        ...
        FizzyoOverlay.UnlockAchievement("First Good Breath", 1);
    ...
    public void StartNewLevel()
    {
        ...
        currentSession = new Session(SessionSetCount, SessionBreathCount);
    ...
    public void EndLevel()
    {
        ...
        FizzyoOverlay.UnlockAchievement("First Set Completed", 1);

        if (CurrentLevel.BadBreathCount == 0)
        {
            FizzyoOverlay.UnlockAchievement("Perfect Set", 1);
        }
        ...
        if (CurrentLevelIndex == Levels.Count - 1)
        {
            ...
            {
                FizzyoOverlay.UnlockAchievement("Perfect Session", 1);
            }

            FizzyoOverlay.UnlockAchievement("First Session Completed", 1);
            FizzyoOverlay.UnlockAchievement("Collect 50 coins", TotalCoins());
    ...
    {
        FizzyoOverlay.ShowLoading();
        yield return new WaitForSeconds(0.5f);
        FizzyoOverlay.ShowSession(currentSession.SessionUpload(TotalGoodBreathCount(), TotalBadBreathCount(), TotalCoins()));
        FizzyoOverlay.LeaderBoard(TotalCoins());
    }
